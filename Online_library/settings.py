...
SECRET_KEY = 'django-insecure-11@9%$iwhukrv^x(#+-$%z(*xr-izii+*hqu4vpqdj!ohp*yn('
...
MEDIA_URL = '/media/'
# Existing uploaded book covers already live under BASE_DIR/book_covers,
# so we serve media from BASE_DIR to avoid breaking current file paths.
MEDIA_ROOT = BASE_DIR
